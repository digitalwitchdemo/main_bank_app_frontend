    ...
    <div className="container my-5 text-color">
      <div className="row align-items-center">
        <div className="col-md-8">
          ...
          <p>
            Built with real-world banking needs in mind, the platform focuses on
            account management, transaction visibility, secure access, and smooth
            customer operations. It brings together the core features expected in
            a digital banking environment while keeping the user experience
